...
public class OptionUtil {
    ...
    public static <T> OptionInstance<T> enumOption(String captionId, OptionInstance.CaptionBasedToString<T> toString, Supplier<T[]> values, Codec<T> codec, T _default, Consumer<T> onUpdate) {
    ...
    public static <T> OptionInstance<T> enumSlider(String captionId, OptionInstance.TooltipSupplier<T> tooltipSupplier, OptionInstance.CaptionBasedToString<T> toString, Supplier<T[]> values, Codec<T> codec, T _default, Consumer<T> onUpdate) {
    ...
    public static <T> OptionInstance<T> enumSlider(String captionId, OptionInstance.CaptionBasedToString<T> toString, Supplier<T[]> values, Codec<T> codec, T _default, Consumer<T> onUpdate) {
